...
(function () {
  ...
  // and for the static showcase pages, which have no Dash and drive the clock themselves.
  window.cislunarPlayback = {draw: draw, state: state, graphs: graphs, readout: readout};
